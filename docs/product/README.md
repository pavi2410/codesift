...
Why codesift exists, who it serves, and long-term strategy. **Feature coverage** (what we build) lives in [capabilities.md](../capabilities.md).

## Reading ladder

1. [vision.md](vision.md) — problem and solution (pitch)
...
- [capabilities.md](../capabilities.md) — planning and status
- [future/](../future/) — exploring ideas before promotion
